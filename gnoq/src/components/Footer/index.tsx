        ...
        <div className="py-14 grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16">
          ...
          <div className="space-y-5">
            <Link href="/" className="inline-block">
              ...
              <img src="/gnoq.png" alt="GNOQ" className="h-9 w-auto rounded-lg" />
            </Link>
            ...
            <div className="flex items-center gap-3 md:hidden pt-1">
              {socials.map(({ href, icon, label }) => (
                <a key={label} href={href} target="_blank" rel="noopener noreferrer"
                  className="flex h-9 w-9 items-center justify-center rounded-lg border border-gray-200 text-gray-400 hover:border-[#4f46e5]/30 hover:text-[#4f46e5] hover:bg-[#4f46e5]/5 transition-all duration-200"
                  aria-label={label}
                >
                  {icon}
                </a>
          ...
          <div className="space-y-5">
            ...
            <ul className="space-y-3">
              {footerLinks.map(({ href, label }) => (
                <li key={href}>
                  <Link href={href} className="text-sm text-gray-500 hover:text-[#4f46e5] transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          <div className="space-y-5">
            ...
            <a href="mailto:gabriel.neves@gnoq.com.br"
              className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-[#4f46e5] transition-colors"
            >
        ...
        <div className="border-t border-gray-100 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-400">
            ...
            <div className="flex items-center gap-5">
              <Link href="/privacidade" className="hover:text-[#4f46e5] transition-colors">Privacidade</Link>
              <Link href="/privacidade" className="hover:text-[#4f46e5] transition-colors">Termos</Link>
            </div>
          </div>
        </div>
